  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col text-[12px]">
        <span className="text-gray-400 dark:text-gray-300 ">Full Name</span>
        <span className="text-gray-600 dark:text-gray-200 ">
          {customer.fullName}
        </span>
      </div>
      <div className="flex flex-col text-[12px]">
        <span className="text-gray-400 dark:text-gray-300 ">City</span>
        <span className="text-gray-500 dark:text-gray-200 ">
          {customer.city}
        </span>
      </div>
      <div className="flex flex-col text-[12px]">
        <span className="text-gray-400 dark:text-gray-300 ">Orders</span>
        <span className="text-gray-500 dark:text-gray-200 ">
          {customer?.totalOrders}
        </span>
      </div>
      <div className="flex flex-col text-[12px]">
        <span className="text-gray-400 dark:text-gray-300 ">Money Spent</span>
